...
class TrueNASCoordinator(DataUpdateCoordinator[None]):
    ...
    def get_updatecheck(self) -> None:
        # update.check_available was removed in TrueNAS SCALE 25.10 (Fangtooth)
        if self._version_major > 25 or (
            self._version_major == 25 and self._version_minor >= 10
        ):
            self.ds["system_info"]["update_status"] = "unknown"
